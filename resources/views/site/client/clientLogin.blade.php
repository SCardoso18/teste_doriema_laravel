  ...
  <div class="login-box-body">
    <p class="login-box-msg">
        @if ($errors->all())
            ...
            @endforeach
        @else
            Iniciar sessão na conta Doriema para efectuar compras!
        @endif
    </p>
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
            <div class="criarconta">
                <a href="{{route('client.showRegister')}}">CRIAR CONTA</a>
            </div>
        </div>
...
<!-- iCheck -->
<script src="{{asset('admim/plugins/iCheck/icheck.min.js')}}"></script>
<script>
  $(function () {
    $('input').iCheck({
